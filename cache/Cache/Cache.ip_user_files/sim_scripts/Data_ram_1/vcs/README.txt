...
#
# Generated by export_simulation on Mon May 30 21:43:41 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Data_ram_1.sh' script.

./Data_ram_1.sh -reset_run
...
./Data_ram_1.sh -noclean_files

For more information on the script, please type './Data_ram_1.sh -help'.
