...
#
# Generated by export_simulation on Mon May 30 21:54:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Tag_ram_1.sh' script.

./Tag_ram_1.sh -reset_run
...
./Tag_ram_1.sh -noclean_files

For more information on the script, please type './Tag_ram_1.sh -help'.
